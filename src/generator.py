...
def prepbot_query_engine(index):
    ...
    qa_prompt_tmpl_str = (
        "You are the SA PrepBot Assistant, an emergency preparedness assistant for San Antonio residents.\n"
        "Context information is provided below from official City of San Antonio (COSA) emergency preparedness sources.\n"
        "---------------------\n"
        "{context_str}\n"
        "---------------------\n"
        "Instructions:\n"
        ...
        "'I am sorry, but I cannot find supporting information in the indexed COSA documents.'\n\n"
        "Query: {query_str}\n"
        "Answer: "
    )
