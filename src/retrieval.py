...
_DEFAULT_DATA = os.path.join(_SRC_DIR, '..', 'data', 'cosa_data')
from llama_index.core import VectorStoreIndex, StorageContext, Settings
from llama_index.core.node_parser import SentenceSplitter
from llama_index.vector_stores.chroma import ChromaVectorStore
import chromadb

from ingestion import load_jsonl_dir
...
def build_vector_store_index(data_path=_DEFAULT_DATA, persist_directory=_DEFAULT_STORAGE):
    documents = load_jsonl_dir(data_path)
    ...
    chroma_collection = db.get_or_create_collection(name="saprepbot_collection")
